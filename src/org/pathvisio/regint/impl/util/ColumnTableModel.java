...
import org.pathvisio.regint.impl.util.ImportInformation.ColumnType;

/**
 * Adjusted version of the table model used in the column page of the Gex Import
 * Wizard. It includes separate coloring for regulator IDs, target IDs,
 * regulator system codes, target system codes and PubMed IDs.
 */
public class ColumnTableModel extends AbstractTableModel {
		...
		private Color getTypeColor(int row, int col) {
			...
			if (info.isHeaderRow(row)) {
				...
				case COL_NUMBER:
					...
					break;
				case COL_STRING:
					result = LIGHT_MAGENTA;
					break;
				case COL_SYSCODE_REG:
					result = LIGHT_RED;
					break;
	...
	public java.awt.Component getTableCellRendererComponent(javax.swing.JTable arg0, Object arg1, boolean arg2,
